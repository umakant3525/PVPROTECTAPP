...
import { View, Text, StyleSheet, Image, Pressable, Alert, SafeAreaView, ScrollView } from "react-native";
...
const DashboardScreen = () => {
  ...
  const [displayCurrentAddress, setDisplayCurrentAddress] = useState("Access unableEnabled ..");
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={{ marginVertical : 10 }}>
        <Text style={{ textAlign : "center"}}> Farming Futures , Forecasted...! </Text>
      </View>
