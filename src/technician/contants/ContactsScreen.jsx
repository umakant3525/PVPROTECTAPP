...
import { SafeAreaView, StyleSheet, Text, TextInput, View, FlatList, Image, TouchableOpacity, Linking } from 'react-native';
    ...
    const renderItem = ({ item }) => (
        <View style={styles.itemContainer}>
            ...
            <View style={styles.rightitemTextContainer}>
                ...
                <TouchableOpacity onPress={() => handleMobilePress(item.mobile)}>
                    <Text style={styles.contactMobile}>
                        <MaterialCommunityIcons name="phone" size={wp('4%')} color="black" /> {item.mobile}
                    </Text>
                </TouchableOpacity>
            </View>
        </View>
